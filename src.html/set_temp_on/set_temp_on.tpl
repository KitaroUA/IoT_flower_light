...
<html>
  ...
  <body>
	...
	<table width="800px">
      ...
      <form method="post" action="set_temp_on.cgi">
        <input type="range" name="temp_on" id="temp_on" min="0" max="90" step="5" value=%v_tempOn% onchange="myFunction_on()" class="slider-width100" />
